...
export const SCIENCE_ENTRIES: ScienceEntry[] = [
  ...
  },
  {
    ...
    evidence:
      "The link between chronic psychosocial stress, cortisol dysregulation, and poor health outcomes is well-established across epidemiological and experimental research. Large cohort studies consistently associate high perceived stress with elevated cardiovascular risk, immune dysfunction, and accelerated biological ageing markers. Mind-body practices that lower cortisol - including regular aerobic exercise, controlled breathing, and adequate sleep - show measurable reductions in resting blood pressure and inflammatory markers in randomised trials.",
  },
  {
    lever: "Daily movement and NEAT",
    mechanism:
      "Non-exercise activity thermogenesis (NEAT) is the energy burned by all movement that is not formal exercise - walking to the kitchen, standing at a desk, taking the stairs. For most people, NEAT accounts for more daily calorie expenditure than structured workouts, because low-level movement is constant. Sedentary behaviour - sitting for prolonged periods - is an independent risk factor for metabolic disease: it reduces the activity of lipoprotein lipase (an enzyme involved in fat clearing from the bloodstream), lowers insulin sensitivity, and contributes to the loss of muscle function over time. Increasing daily step count, even without any change to gym sessions, measurably improves blood sugar regulation and cardiovascular biomarkers.",
    evidence:
      "Epidemiological research consistently shows that higher daily step counts are associated with lower all-cause mortality and cardiovascular disease risk, with meaningful benefits appearing from around 7,000 steps per day upward. The WHO Physical Activity Guidelines recommend reducing sedentary behaviour specifically and note that any amount of additional physical activity - including light activity - confers health benefit beyond being sedentary. Multiple randomised trials have shown that breaking up prolonged sitting with short bouts of walking improves postprandial glucose and insulin responses.",
  },
  {
    lever: "Body fat and visceral fat",
    mechanism:
      "Not all body fat carries the same risk. Visceral fat - the fat stored deep in the abdominal cavity around the liver, pancreas, and intestines - is metabolically active tissue. It secretes inflammatory cytokines (such as IL-6 and TNF-alpha), releases fatty acids directly into the portal circulation, and promotes insulin resistance in the liver. This makes visceral fat a central driver of type 2 diabetes, non-alcoholic fatty liver disease, and cardiovascular disease. Subcutaneous fat (under the skin) carries much lower risk. The good news is that visceral fat is highly responsive to the interventions in this programme: aerobic exercise, resistance training, improved diet quality, and better sleep all reduce visceral fat preferentially, often before visible body composition changes appear.",
    evidence:
